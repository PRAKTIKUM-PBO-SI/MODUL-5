...
public class InputBuku extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tahun Terbit Buku");

        jLabel5.setText("Harga Buku");

        jLabel6.setText("Kategori Buku");

        boxKategori.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { null, "Novel", "Majalah", "Komik" }));
